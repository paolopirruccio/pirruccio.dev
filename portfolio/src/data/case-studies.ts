...
export const caseStudies:CaseStudy[]=[
  {
    slug:"laprendoconsport",title:"Laprendoconsport",eyebrow:"Sport · Salute · Cultura",summary:"Un ecosistema editoriale che rende lo sport più comprensibile, autorevole e vicino alle persone.",year:"2025",services:["Brand system","UX/UI","Web design"],role:"Design & sviluppo",website:"/laprendoconsport.html",
    ...
    screenshots:[{src:"/assets/opt/laprendoconsport.webp",alt:"Homepage Laprendoconsport",caption:"Homepage",size:"wide"},{alt:"Pagina articolo",caption:"Template editoriale",size:"tall"},{alt:"Vista mobile",caption:"Navigazione mobile"}],
  ...
  },
  {
    ...
    screenshots:[{src:"/assets/opt/astergift.webp",alt:"AsterGift website",caption:"Direzione visuale",size:"wide"},{alt:"Catalogo delle stelle",caption:"Catalogo",size:"standard"},{alt:"Scheda prodotto",caption:"Product detail",size:"tall"}],
  ...
  {
    slug:"nasa",title:"Opportunity",eyebrow:"NASA · Educational · Immersive",summary:"Un viaggio digitale nella missione Opportunity, costruito come un piccolo archivio interattivo da esplorare.",year:"2022",services:["Web experience","Interaction design","Visual storytelling"],role:"Design & front-end",website:"/ppw/index.html",logo:"/ppw/images/green-logo.png",logoAlt:"Opportunity project logo",
    ...
    logoStudy:[{src:"/ppw/images/green-logo.png",label:"Marchio principale"},{src:"/ppw/images/blue-logo.png",label:"Variante cromatica"},{src:"/ppw/images/violet-logo.png",label:"Sistema di varianti"}],
    ...
    screenshots:[{src:"/assets/opt/ppw.webp",alt:"Opportunity homepage",caption:"Homepage",size:"wide"},{src:"/assets/opt/ppw-2.webp",alt:"Opportunity internal page",caption:"Mission archive",size:"tall"},{src:"/assets/opt/ppw-3.webp",alt:"Opportunity project detail",caption:"Interactive content",size:"standard"}],
  ...
  },
  {
    ...
    logoStudy:[{src:"/assets/logos/sarcofago.png",label:"Monogramma"},{label:"Costruzione",note:"Spazio per griglia e proporzioni."},{label:"Applicazioni",note:"Segnaletica e declinazioni digitali."}],
    ...
    screenshots:[{src:"/assets/opt/3d.webp",alt:"Homepage del Sarcofago Tebanianus",caption:"Homepage",size:"wide"},{src:"/assets/opt/3d-2.webp",alt:"Modello 3D",caption:"Esplorazione 3D",size:"tall"},{src:"/assets/opt/3d-3.webp",alt:"Contenuto storico",caption:"Approfondimento"}],
  ...
  {
    slug:"bussola-infouma",title:"La Bussola di Infouma",eyebrow:"Università · Community · Orientamento",summary:"Un punto di riferimento digitale per orientarsi tra corsi, strumenti e vita universitaria.",year:"2023",services:["Product design","Information architecture","Front-end"],role:"UX/UI & sviluppo",website:"/bussola/index.html",logo:"/assets/opt/compass-logo.webp",logoAlt:"La Bussola di Infouma",
    ...
    logoStudy:[{src:"/assets/opt/compass-logo.webp",label:"Simbolo"},{label:"Griglia",note:"Costruzione della bussola."},{label:"Iconografia",note:"Sistema di segni per le categorie."}],
    ...
    screenshots:[{src:"/assets/opt/bussola.webp",alt:"Homepage La Bussola",caption:"Homepage",size:"wide"},{src:"/assets/opt/bussola-2.webp",alt:"Risorse universitarie",caption:"Archivio risorse"},{src:"/assets/opt/bussola-3.webp",alt:"Pagina interna",caption:"Navigazione",size:"tall"}],
  ...
  {
    slug:"blogowl",title:"BlogOwl",eyebrow:"Social · Publishing · Product",summary:"Una piattaforma che raccoglie blog diversi e rende naturale scoprirli, seguirli e discuterne.",year:"2023",services:["Product UX","Interface design","Web development"],role:"Design & sviluppo",website:"/bdd/login.html",logo:"/bdd/illustrazioni/logo-navbar.svg",logoAlt:"BlogOwl",
    ...
    logoStudy:[{src:"/bdd/illustrazioni/logo-navbar.svg",label:"Marchio"},{label:"Mascotte",note:"Espressioni e riduzioni del gufo."},{label:"Icona",note:"Test alle piccole dimensioni."}],
    ...
    screenshots:[{src:"/assets/opt/blogowl.webp",alt:"Interfaccia BlogOwl",caption:"Direzione di prodotto",size:"wide"},{alt:"Feed editoriale",caption:"Feed"},{alt:"Profilo autore",caption:"Profilo",size:"tall"}],
  ...
  {
    slug:"text-encoding",title:"Text Encoding Project",eyebrow:"TEI · Ricerca · Digital Humanities",summary:"Uno strumento accademico per codificare, confrontare e leggere il testo come struttura e come contenuto.",year:"2022",services:["Research UX","Data interface","Front-end"],role:"UX/UI & sviluppo",website:"/codifica/codifica.html",focus:"product",
    ...
    logoStudy:[{src:"/codifica/immagini/logo.webp",label:"Marchio"},{label:"Sintassi",note:"Segni derivati dal markup."},{label:"Riduzione",note:"Versione per navigazione e favicon."}],
    ...
    screenshots:[{src:"/assets/opt/codifica.webp",alt:"Homepage Text Encoding Project",caption:"Homepage",size:"wide"},{src:"/assets/opt/codifica-2.webp",alt:"Confronto del testo",caption:"Confronto",size:"tall"},{src:"/assets/opt/codifica-3.webp",alt:"Vista codificata",caption:"Codifica"}],

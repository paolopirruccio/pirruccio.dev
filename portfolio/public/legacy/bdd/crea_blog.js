document.addEventListener('DOMContentLoaded', function() {
    ...
    const bottoneTornaHome = document.getElementById('bottoneTornaHome');
    const menuConferma = document.getElementById('menuConferma');
    const confermaTornaHome = document.getElementById('confermaTornaHome');
    const annullaTornaHome = document.getElementById('annullaTornaHome');

    bottoneTornaHome.addEventListener('click', function(e) {
        e.preventDefault();
        menuConferma.classList.add('active');
    });

    confermaTornaHome.addEventListener('click', function() {
        window.location.href = 'index.php';
    });

    annullaTornaHome.addEventListener('click', function() {
        menuConferma.classList.remove('active');
    });
    ...
    const hiddenSelect = document.getElementById('tema');
    ...
    customOptions.forEach(option => {
        option.addEventListener('click', function () {
            if (!option.classList.contains('disabled')) {
                ...
                customSelectTrigger.querySelector('#selectedTheme').textContent = label;
